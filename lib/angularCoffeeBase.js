...
(function() {
  ...
  angularCoffeeBase.classFactory = function(options, classDefinition) {
    ...
    factory = function() {
      ...
      })((superClassIsInjected ? injectedByName[superClass] : superClass));
...
(function() {
  ...
  angularCoffeeBase.delegates = function(klass) {
    return function() {
      var getDelegatee, opts, propertiesAndMethods, withNullAllowance, _i;
      ...
      withNullAllowance = (function(_this) {
        return function(allowNull) {
          return function(delegatee, doSomething) {
            if ((delegatee != null) || !allowNull) {
              return doSomething(delegatee);
            } else {
              return delegatee;
            }
          };
          ...
          (function(_this) {
            return (function(methodName) {
              klass.prototype[methodName] = function() {
                var args;
                args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
                return withNullAllowance(getDelegatee.call(this), function(delegatee) {
                  return delegatee[methodName].apply(delegatee, args);
                });
              };
            });
          ...
          (function(_this) {
            return (function(propertyName) {
              ...
              angularCoffeeBase.defineProperty(klass)(propertyName, {
                ...
                get: function() {
                  return withNullAllowance(getDelegatee.call(this), function(delegatee) {
                    return delegatee[propertyName];
                  });
                },
                set: function(value) {
                  return withNullAllowance(getDelegatee.call(this), function(delegatee) {
                    return delegatee[propertyName] = value;
                  });
                }
              });
            });
...
/*
 code here is temporarily moved to ./angularCoffeeBase/0_self.coffee
